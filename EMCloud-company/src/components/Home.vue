...
<!--        <img src="../assets/imgs/shop.png" >-->
      ...
      <div class="right">
        ...
        <el-button round size="mini" @click="exit">退出</el-button>
      </div>
    </el-header>
...
<!--        <el-divider></el-divider>-->
        <el-menu :default-active="$route.path" unique-opened router :collapse="isCollapse" :collapse-transition="false" background-color="#000000" text-color="#fff" >
